  ...
  return (
    <div className="relative w-5/6 rounded-3xl" ref={dropdownRef}>
      <button
        ...
        className={`flex w-full cursor-pointer items-center border border-silver bg-green-1000 p-[14px] dark:bg-transparent ${
          isDocsListOpen
      ...
      {isDocsListOpen && (
        <div className="absolute left-0 right-0 z-50 -mt-1 max-h-28 overflow-y-auto rounded-b-xl border border-silver bg-white shadow-lg dark:border-silver/40 dark:bg-dark-charcoal">
          ...
          <div
            className="flex cursor-pointer items-center justify-between hover:bg-gray-100 dark:text-bright-gray dark:hover:bg-purple-taupe bg-green-1000 dark:bg-green"
            onClick={handleEmptyDocumentSelect}
          >
            <span
              className="ml-4 flex-1 overflow-hidden overflow-ellipsis whitespace-nowrap py-3 bg-green-1000 dark:bg-green"
              onClick={() => {
