...
export default function Navigation({ navOpen, setNavOpen }: NavigationProps) {
  ...
  const isFeatureAvailable = false; // Set this dynamically based on your logic
  ...
  return (
    <>
      {!navOpen && (
        <div className="duration-25 absolute  top-3 left-3 z-20 hidden transition-all md:block">
          <div className="flex gap-3 items-center">
            ...
            <div className="text-[#949494] font-medium text-[20px] dark:text-white">
              OratioTechnologies
            </div>
          </div>
        </div>
      ...
      <div
        ...
        } duration-20 fixed top-0 z-20 flex h-full w-72 flex-col border-r-[1px] border-b-0 bg-white transition-all dark:border-r-purple-taupe dark:bg-[#021610] dark:text-white`}
      >
        <div
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `${
              isActive ? 'bg-grey-3000 dark:bg-grey-3000' : ''
            } group sticky mx-4 mt-4 flex cursor-pointer gap-2.5 rounded-3xl border border-silver p-3 hover:border-rainy-gray hover:bg-green-1000 dark:border-purple-taupe dark:text-white dark:hover:bg-green`
          }
        >
          <img
            src={Add}
            ...
            <div className="relative my-4 mx-4 flex gap-2">
              ...
              <SourceDropdown
                ...
                handlePostDocumentSelect={(option?: string) => {
                  if (!isFeatureAvailable) return; // Prevent interaction when disabled
                  if (isMobile) {
                    setNavOpen(!navOpen);
                  }
                }}
              ...
              <img
                ...
                title={isFeatureAvailable ? '' : 'Premium feature'}
              />
            </div>
        ...
        <div className="flex h-auto flex-col justify-end text-eerie-black dark:text-white">
          <div className="flex flex-col gap-2 border-b-[1px] py-2 dark:border-b-purple-taupe">
            <NavLink
              ...
              to="/settings"
              className={({ isActive }) =>
                `my-auto mx-4 flex h-9 cursor-pointer gap-4 rounded-3xl hover:bg-gray-100 dark:hover:bg-[#08392a] ${
      ...
      <div className="sticky z-10 h-16 w-full border-b-2 bg-gray-50 dark:border-b-purple-taupe dark:bg-green md:hidden">
        <div className="flex gap-6 items-center h-full ml-6 ">
          ...
          <div className="text-[#949494] font-medium text-[20px]">Oratio</div>
        </div>
      </div>
      <APIKeyModal
