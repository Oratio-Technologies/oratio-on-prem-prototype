...
export default function Hero({
  ...
  return (
    ...
    >
      ...
      <div className="mb-16 grid w-full grid-cols-1 items-center gap-4 self-center text-xs sm:w-auto sm:gap-6 md:mb-0 md:text-sm lg:grid-cols-1">
        {demos?.map(
          (demo: { header: string }, key: number) =>
            demo.header && (
              <Fragment key={key}>
                <button className="w-full rounded-full bg-green-1000 dark:bg-green dark:text-white border border-silver px-6 py-4 text-left hover:border-gray-4000 dark:hover:border-gray-3000 xl:min-w-[24vw]">
