  ...
  return (
    <>
      <div
        ...
        className={`my-auto mx-4 mt-4 flex h-9 cursor-pointer items-center justify-between pl-4 gap-4 rounded-3xl hover:bg-green-1000 dark:hover:bg-green ${
          conversationId === conversation.id || isOpen || isHovered
            ? 'bg-green-1000 dark:bg-green'
            : ''
        }`}
      >
            ...
            {isOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="flex-start flex items-center gap-4 p-3 hover:bg-green-1000 dark:hover:bg-green-3000"
                >
                  <img
                    src={Edit}
                    alt="Edit"
                ...
                <button
                  ...
                  className="flex-start flex items-center gap-3 rounded-b-xl p-2 text-red-700 hover:bg-green-1000 dark:hover:bg-green-3000"
                >
                  <img
                    src={Trash}
                    alt="Edit"
