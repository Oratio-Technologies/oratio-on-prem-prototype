...
const conversationService = {
  ...
  regenerate: (data: any): Promise<any> =>
    apiClient.post(endpoints.CONVERSATION.REGENERATE, data),
  summarize: (data: any): Promise<any> =>
    apiClient.post(endpoints.CONVERSATION.SUMMARIZE, data),
  expand: (data: any): Promise<any> =>
    apiClient.post(endpoints.CONVERSATION.EXPAND, data),
};
