...
# # Directly output to Qdrant feature store without additional processing
# op.output(
#     "raw data insert to qdrant",
#     stream,
#     QdrantOutput(connection=connection, sink_type="clean")  # Modify sink_type as needed
# )
