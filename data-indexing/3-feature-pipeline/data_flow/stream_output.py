...
class QdrantOutput(DynamicSink):
    ...
    def __init__(self, connection: QdrantDatabaseConnector, sink_type: str):
        ...
        try:
            self._connection.get_collection(collection_name="cleaned_pdfs")
        except UnexpectedResponse:
            logger.info(
                "Couldn't access the collection. Creating a new one...",
                collection_name="cleaned_pdfs",
            )
        ...
        try:
            self._connection.get_collection(collection_name="vector_pdfs")
        except UnexpectedResponse:
            logger.info(
                "Couldn't access the collection. Creating a new one...",
            ...
            self._connection.create_vector_collection(collection_name="vector_pdfs")
