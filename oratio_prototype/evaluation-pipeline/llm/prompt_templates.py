...
class InferenceTemplate(BasePromptTemplate):
    ...
    Step 3: Generate the content keeping in mind that it needs to be as cohesive and concise as possible related to the subject presented in the query and knowledge presented in the context.
    """
...
class RAGEvaluationTemplate(BasePromptTemplate):
    ...
    The given context is comprised of custom data for text documents chosen by the user.
